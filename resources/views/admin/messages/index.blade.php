...
@section('header')
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Mengelola pesan masuk dari pengunjung</p>
        </div>
    </div>
@endsection
                ...
                <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($messages as $message)
                                        <tr class="hover:bg-gray-50 transition duration-150 {{ !$message->is_read ? 'bg-blue-50' : '' }}">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Belum ada pesan masuk dari pengunjung.</p>
                        </div>
                    @endif
                </div>
            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $messages->where('is_read', false)->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
