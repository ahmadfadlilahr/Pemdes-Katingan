...
@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('admin.heroes.update', $hero) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div class="xl:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('title') border-red-300 @else border-gray-300 @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  id="description"
                                  rows="4"
                                  class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-300 @else border-gray-300 @enderror"
                                  placeholder="Deskripsi hero (opsional)">{{ old('description', $hero->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button1_text') border-red-300 @else border-gray-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="url"
                                           name="button1_url"
                                           id="button1_url"
                                           value="{{ old('button1_url', $hero->button1_url) }}"
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button1_url') border-red-300 @else border-gray-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <select name="button1_style"
                                        ...
                                        <option value="primary" {{ old('button1_style', $hero->button1_style) === 'primary' ? 'selected' : '' }}>Primary (Biru)</option>
                                        <option value="secondary" {{ old('button1_style', $hero->button1_style) === 'secondary' ? 'selected' : '' }}>Secondary (Putih)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button2_text') border-red-300 @else border-gray-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="url"
                                           name="button2_url"
                                           id="button2_url"
                                           value="{{ old('button2_url', $hero->button2_url) }}"
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button2_url') border-red-300 @else border-gray-300 @enderror"
                                           placeholder="https://example.com">
                                    @error('button2_url')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select name="button2_style"
                                            id="button2_style"
                                            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                        <option value="secondary" {{ old('button2_style', $hero->button2_style) === 'secondary' ? 'selected' : '' }}>Secondary (Putih)</option>
                                        <option value="primary" {{ old('button2_style', $hero->button2_style) === 'primary' ? 'selected' : '' }}>Primary (Biru)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-3 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-gray-900">{{ $hero->created_at->format('d M Y H:i') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-500">Diperbarui:</span>
                                    <span class="text-gray-900">{{ $hero->updated_at->format('d M Y H:i') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-500">Pembuat:</span>
                                    <span class="text-gray-900">{{ $hero->user->name ?? 'Unknown' }}</span>
                                </div>
                            </div>
                            ...
                            <div>
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox"
                                           name="show_title"
                                           value="1"
                                           {{ old('show_title', $hero->show_title) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number"
                                       name="order_position"
                                       id="order_position"
                                       value="{{ old('order_position', $hero->order_position) }}"
                                       min="0"
                                       class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="0">
                                <p class="mt-1 text-xs text-gray-500">Semakin kecil angka, semakin di depan urutan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Featured Image -->
                    <div class="bg-gray-50 rounded-lg p-4">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Gambar Hero</h3>
                        ...
                        @if($hero->image)
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    <img src="{{ $hero->image_url }}" alt="{{ $hero->title }}" class="w-full h-40 object-cover rounded-md border">
                                    <div class="absolute inset-0 bg-black bg-opacity-40 rounded-md flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-200">
                                        <p class="text-white text-sm font-medium">Klik untuk melihat gambar penuh</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                                {{ $hero->image ? 'Ganti Gambar' : 'Upload Gambar' }}
                            </label>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span id="uploadText">{{ $hero->image ? 'Ganti gambar' : 'Upload gambar' }}</span>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <a href="{{ route('admin.heroes.show', $hero) }}"
                               class="flex justify-center py-2 px-4 border border-green-300 rounded-md shadow-sm text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                Preview
                            </a>
                            <a href="{{ route('admin.heroes.index') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            removeImageBtn.addEventListener('click', function() {
                ...
                uploadText.textContent = @json($hero->image ? 'Ganti gambar' : 'Upload gambar');
            });
