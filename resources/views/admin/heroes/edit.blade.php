                ...
                <div class="xl:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('title') border-red-300 @else @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  id="description"
                                  rows="4"
                                  class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-300 @else @enderror"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button1_text') border-red-300 @else @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="url"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button1_url') border-red-300 @else @enderror"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button2_text') border-red-300 @else @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="url"
                                           ...
                                           class="block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('button2_url') border-red-300 @else @enderror"
                                           placeholder="https://example.com">
                                    @error('button2_url')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
