                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="google_maps_embed" id="google_maps_embed" rows="4"
                                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 font-mono text-xs"
                                              placeholder="Paste Google Maps embed code atau URL di sini...">{{ old('google_maps_embed') }}</textarea>
