...
<div class="grid grid-cols-1 gap-3 sm:gap-4 mb-6 sm:mb-8">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-3 sm:p-4 border-l-4 border-blue-500 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-3 min-w-0 flex-1">
                <p class="text-xs sm:text-sm font-medium text-blue-800 mb-0.5">Hotline Dinas</p>
                <a href="tel:{{ $contact->phone }}" class="text-base sm:text-lg font-bold text-blue-900 hover:text-blue-700 transition-colors duration-200 block truncate">
                    {{ $contact->phone }}
                </a>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border-l-4 border-green-500 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-3 min-w-0 flex-1">
                <p class="text-xs sm:text-sm font-medium text-green-800 mb-0.5">Email Resmi</p>
                <a href="mailto:{{ $contact->email }}" class="text-xs sm:text-sm lg:text-base font-bold text-green-900 hover:text-green-700 transition-colors duration-200 block truncate">
                    {{ $contact->email }}
                </a>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-lg p-3 sm:p-4 border-l-4 border-emerald-500 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-3 min-w-0 flex-1">
                <p class="text-xs sm:text-sm font-medium text-emerald-800 mb-0.5">WhatsApp</p>
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contact->whatsapp) }}" target="_blank" rel="noopener noreferrer" class="text-base sm:text-lg font-bold text-emerald-900 hover:text-emerald-700 transition-colors duration-200 block truncate">
                    {{ $contact->whatsapp }}
                </a>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-3 sm:p-4 border-l-4 border-blue-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-base sm:text-lg font-bold text-blue-900">-</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border-l-4 border-green-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-xs sm:text-sm font-bold text-green-900">-</p>
            </div>
        </div>
    </div>
</div>
