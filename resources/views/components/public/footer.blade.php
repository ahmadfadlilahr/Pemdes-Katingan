            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-gray-300 text-sm">Jl. Raya Kasongan No. 123</p>
                            <p class="text-gray-300 text-sm">Kasongan, Kabupaten Katingan</p>
                            <p class="text-gray-300 text-sm">Kalimantan Tengah 74411</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        ...
                        <p class="text-gray-300 text-sm">(0536) 21234</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <p class="text-gray-300 text-sm">info@pmdkatingan.go.id</p>
                    </div>
                </div>
            </div>
        </div>
