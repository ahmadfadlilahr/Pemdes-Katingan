    ...
    <div class="px-6 py-6">
        <form method="post" action="{{ route('password.update') }}" class="space-y-6">
            ...
            <div x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    ...
                    <input id="update_password_current_password"
                           ...
                           class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('current_password', 'updatePassword') @enderror"
                           placeholder="••••••••"
            ...
            <div x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    ...
                    <input id="update_password_password"
                           name="password"
                           :type="showPassword ? 'text' : 'password'"
                           class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('password', 'updatePassword') @enderror"
                           placeholder="••••••••"
            ...
            <div x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    ...
                    <input id="update_password_password_confirmation"
                           ...
                           :type="showPassword ? 'text' : 'password'"
                           class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('password_confirmation', 'updatePassword') @enderror"
                           placeholder="••••••••"
                           autocomplete="new-password">
                    <button type="button"
                            @click="showPassword = !showPassword"
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <button type="submit"
                        class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
